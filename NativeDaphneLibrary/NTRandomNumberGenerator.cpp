...
namespace NativeDaphneLibrary
{
	...
	NTRandomNumberGenerator::NTRandomNumberGenerator(){}
	...
	bool NTRandomNumberGenerator::Initialize(int seed)
	{
	...
	bool NTRandomNumberGenerator::Sample(int n, double mean, double variance, double *x)
	{
