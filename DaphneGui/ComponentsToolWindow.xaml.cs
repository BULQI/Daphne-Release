...
namespace DaphneGui
{
    ...
    public partial class ComponentsToolWindow : ToolWindow
    {
        ...
        //    DependencyProperty.Register("ToolWinType", typeof(ToolWindowType), 
        //    typeof(ComponentsToolWindow), 
        //    new FrameworkPropertyMetadata(ToolWindowType.BaseType, new PropertyChangedCallback(OnToolWinTypeChanged)));
        ...
        private void BulkOnlyReactionFilter(object sender, FilterEventArgs e)
        {
        ...
        public void toolWinTypeChanged(ToolWindowType twtype)
        {
            CollectionViewSource cvs = (CollectionViewSource)(FindResource("moleculesListView"));
            if (cvs != null && cvs.View != null)
            {

                if (twtype == ToolWindowType.Tissue)
                {
                    cvs.View.Filter = null;
                    //cvs.Filter -= BulkMoleculesListView_Filter;
                }
                else if (twtype == ToolWindowType.VatRC)
                {
                    cvs.Filter += BulkMoleculesListView_Filter;
                }
                cvs.View.Refresh();
            ...
            //ecmReactionsListView
            cvs = (CollectionViewSource)(FindResource("ecmReactionsListView"));
            if (cvs != null && cvs.View != null)
            {
                ...
                {
                    cvs.View.Filter = null;
                    //cvs.Filter -= BulkOnlyReactionFilter;
                }
                else if (twtype == ToolWindowType.VatRC)
                {
                    cvs.Filter += BulkOnlyReactionFilter;
        ...
        private static void OnToolWinTypeChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            ComponentsToolWindow ctw = d as ComponentsToolWindow;
            ToolWindowType value = (ToolWindowType)e.NewValue;
            ctw.toolWinTypeChanged(value);
        }
