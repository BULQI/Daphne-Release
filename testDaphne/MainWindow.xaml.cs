...
namespace testDaphne
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void DriverLocomotionScenario()
        {
            ...
            Simulation.dataBasket.ECS.Space.Populations["CXCL13"].boundaryCondition.Add(n, MolBoundaryType.Dirichlet);
        ...
        public void FluxNaturalBoundaryConditions()
        {
            ...
            int n = Simulation.dataBasket.ECS.Sides["right"];
            Simulation.dataBasket.ECS.Space.Populations["CXCL13"].boundaryCondition.Add(n, MolBoundaryType.Neumann);
